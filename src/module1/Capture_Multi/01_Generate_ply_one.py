...
def create3DFromImages_Filter_Border(sensor,frame,filtro):
    ...
    if  filtro==0:
        ...
        mask_1= cv2.inRange(depth_gray,0,9)
...
k_list=[1,2,3,5] #Segun el numero de camaras
...
for w in range (frame_ini,frame_final+step,step):
  ...
  for i in k_list:
    ...
    min_bound=(-0.10024430,-0.08934654,0.09290001),
    max_bound=(0.10040893, 0.11468616,0.27063152))
    ...
    o3d.io.write_point_cloud("Points_Cloud/Frame_"+str(w)+"/k0"+str(i)+".ply",cropped_pcd)
