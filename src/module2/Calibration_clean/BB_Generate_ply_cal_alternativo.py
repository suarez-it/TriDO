...
def getMa(k_list,xp):
    ...
    for i in k_list:
            ...
            if pcd_name=="pcd1":
                ...
                T1_a = np.load("./Matrices_Iniciales/k07k01.npy")
                np.save('./Final_Ma/pcd7.npy', T_C_Prom)
...
for j in range(frame_ini,frame_fin+step,step):
    ...
    carpeta2 = "Points_Cloud_calibra/Frame_"+str(j)
    ...
    for i in k_list:
        ...
        o3d.io.write_point_cloud("Points_Cloud_calibra/Frame_"+str(j)+"/k0"+str(i)+".ply", pcdto)
